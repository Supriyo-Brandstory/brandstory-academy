...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-7 text-md-start text-center">
                    <h1 class="mb-3">Expert-led <span class="text-violet"> Digital Marketing Course</span> in Vijayanagar, Bangalore</h1>
                    <p class="mb-4"><span >Step into the future of marketing with the Digital Marketing Program in Vijayanagar offered 
                        by BrandStory Academy. This course equips learners with modern marketing skills, blending core digital strategies 
                        with practical tools and techniques that are transforming the industry.</p>
                ...
                <div class="col-lg-6 col-md-5">
                    <img class="w-100" src="{{asset('frontend/assets/images/courses/digital-marketing-course-vijayanagar.webp')}}" alt="Expert-led Digital Marketing Course in Vijayanagar, Bangalore - BrandStory Academy">
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 px-2 text-center text-lg-start order-2 order-lg-1">
                    <p><a href="https://www.brandstoryacademy.com" style="color: black; font-size: 18px; text-decoration: underline;"><b>BrandStory Academy</a></b>
                         is a leading digital marketing institute in Vijayanagar, Bangalore, offering industry-focused courses designed to make students job-ready. We provide 
                         flexible learning options, including offline classes and self-paced programs, guided by experienced professionals who bring real-world insights 
                         into every session.</p>
                    <p>As the digital marketing landscape evolves rapidly, our advanced curriculum covers the latest marketing strategies, tools, and techniques. 
                        Students gain hands-on experience with live projects, practical assignments, and industry-relevant skills, preparing them for rewarding careers. 
                        With access to <b>1,000+ global hiring partners</b> and over 5 years of expertise in digital marketing education, BrandStory Academy ensures every 
                        learner receives personalized guidance, complete training, and the support needed to succeed in top agencies worldwide.</p>
    ...
    <section class="spb-100 why-enroll-coursepage">
        <div class="container">
            ...
            <p class="frame-700 text-center">BrandStory Academy is the best digital marketing institute, offering practical, industry-focused training. 
                Our expert faculty guide students through real-world marketing strategies, and with <b>1,000+ placement partners</b>, we help them secure 
                opportunities in top agencies worldwide.</p>
            <div class="row whychoose-boxes ">
                <div class="col-12 col-lg-4 mb-4 ">
                    <div class="box y-top">
                        <img src="{{ asset('frontend/assets/images/courses/certificate.svg') }}" />
                        <h4>Certifications</h4>
                        <p>Obtain internationally recognized certifications from BrandStory Academy & from HubSpot, Google Ads, Semrush, and more. These 
                            credentials enhance your digital marketing skills and give your resume a competitive edge.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box g-top">
                        ...
                        <p>Gain practical experience by managing live SEO, PPC, and social media campaigns while learning to track and analyze 
                            performance metrics with guidance from industry experts.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box s-top">
                        ...
                        <p>Get complete placement assistance, from crafting effective resumes and practicing mock interviews to connecting with leading hiring 
                            partners across multiple industries with a 100% placement guarantee.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box r-top">
                        ...
                        <p>Attend industry-led interview workshops to sharpen your communication, presentation, and problem-solving skills, 
                            with expert 1:1 guidance to make you fully job-ready.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box v-top">
                        ...
                        <p>Learn from experienced marketing professionals who share practical insights in every session. Benefit from 
                            interactive group classes as well as personalized one-on-one mentoring.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box o-top">
                        ...
                        <p>Build key communication, leadership, and personal branding skills to excel in the digital marketing world, 
                            while gaining the right opportunities to kickstart your career.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="curicullmn-coursepage spb-100">
        <div class="container">
            ...
            <p class="frame-1100 text-center">
                Our digital marketing curriculum includes <b>30+ industry-relevant modules</b> designed to build strong practical skills. As one of the top digital marketing 
                institutes in Bangalore, we offer an advanced, job-focused program with complete placement support. Backed by <b>10+ years of expertise</b>, we provide high-quality 
                and affordable digital marketing training for learners at every level.
            </p>
