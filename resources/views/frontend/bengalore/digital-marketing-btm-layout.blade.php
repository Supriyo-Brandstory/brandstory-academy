...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-7 text-md-start text-center">
                    <h1 class="mb-3">Leading <span class="text-violet"> Digital Marketing Training</span> Institute in BTM Layout, Bangalore</h1>
                    <p class="mb-4"><span >Kickstart your career with an advanced digital marketing program by BrandStory Academy designed for beginners, students, and 
                        working professionals. Learn 30+ in-demand modules, practice with industry tools, build live projects, and earn globally recognized 
                        certifications.</p>
                ...
                <div class="col-lg-6 col-md-5">
                    <img class="w-100" src="{{asset('frontend/assets/images/courses/digital-marketing-course-btm-layout.webp')}}" alt="Leading Digital Marketing Training Institute in BTM Layout, Bangalore - BrandStory Academy">
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 px-2 text-center text-lg-start order-2 order-lg-1">
                    <p><a href="https://www.brandstoryacademy.com" style="color: black; font-size: 18px; text-decoration: underline;"><b>BrandStory Academy</a></b>
                        is one of the top-rated digital marketing institutes in BTM Layout, offering industry-focused digital marketing courses with both classroom 
                        and self-paced learning options. Powered by the expertise of our successful digital marketing agency, we train students with practical skills, 
                        live project exposure, and career-oriented guidance- helping them secure better salary packages and ensuring <b>100% placement 
                        support</b>.</p>
                    <p>As the digital marketing industry continues to evolve, our curriculum is constantly updated to match the latest trends. Students gain hands-on 
                        experience with <b>advanced AI-driven tools</b>, modern marketing strategies, and real-world campaign execution. Every learner is trained to be completely 
                        job-ready and connected to over <b>1000+ hiring partners</b>. With 5+ years of excellence in digital marketing training, BrandStory Academy ensures a 
                        comprehensive, future-ready learning experience for aspiring digital marketers.</p>
    ...
    <section class="spb-100 why-enroll-coursepage">
        <div class="container">
            ...
            <p class="frame-700 text-center">BrandStory Academy is one of Bangalore’s leading digital marketing institutes, providing expert-led and industry-driven learning experiences. 
                Our highly experienced faculty ensures students master every essential aspect of digital marketing with clarity and confidence. With a strong network of <b>1000+ placement 
                    partners</b>, we help learners secure opportunities in top global agencies.</p>
            <div class="row whychoose-boxes ">
                <div class="col-12 col-lg-4 mb-4 ">
                    <div class="box y-top">
                        <img src="{{ asset('frontend/assets/images/courses/certificate.svg') }}" />
                        <h4>Certifications</h4>
                        <p>Earn globally recognized certifications from platforms like HubSpot, Google Ads, and Semrush. These credentials enhance your digital marketing expertise and give your resume a strong competitive edge.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box g-top">
                        ...
                        <p>Gain practical experience by executing real SEO, PPC, and social media campaigns while learning to analyze performance metrics with expert guidance and support.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box s-top">
                        ...
                        <p>Get end-to-end placement assistance, including resume enhancement, mock interviews, and access to leading hiring partners across multiple industries.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box r-top">
                        ...
                        <p>Take part in expert-led interview workshops designed to strengthen your presentation, analytical thinking, and communication skills. Our guidance ensures you become fully job-ready.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box v-top">
                        ...
                        <p>Learn directly from experienced marketing professionals who bring real industry insights to every session. Benefit from a mix of collaborative group learning and personalized 1-to-1 training.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box o-top">
                        ...
                        <p>Develop strong communication, leadership, and personal branding skills that help you stand out in the digital marketing landscape. We ensure you’re equipped with the right opportunities and guidance.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="Benefit-coursepage">
        <div class="container">
            ...
            <p class="text-center frame-800">Our digital marketing course in Bangalore is crafted for learners who aspire to become job-ready digital
                marketing professionals. With industry-recognized certifications and practical, <b>hands-on training</b>, 
                we equip you with the skills needed to grow confidently in your career. </p>
    ...
    <section class="Certified-coursepage sp-100">
        ...
        <div class="container">
            <h2 class="text-center frame mb-4">From Fresher to Experienced Professional Get
                Certified as a Professional <span class="text-violet">Digital Marketer</span></h2>
                <p class="text-center frame mb-5">Earn a recognized digital marketing <b>certification from BrandStory Academy</b> upon completing our 
                    digital marketing course in BTM Layout, Bangalore. This credential showcases your expertise and helps you stand out confidently in a 
