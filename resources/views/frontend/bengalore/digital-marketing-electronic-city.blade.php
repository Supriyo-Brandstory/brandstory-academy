...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-7 text-md-start text-center">
                    <h1 class="mb-3">Best-rated <span class="text-violet"> Digital Marketing Course</span> in Electronic City, Bangalore</h1>
                    <p class="mb-4"><span >Job-ready digital marketing course in Electronic City with 30+ advanced learning modules, 50+ AI-powered tools, and industry-recognized
                         certifications. As the best digital marketing institute in Electronic City, we collaborate with 1000+ global placement partners to support your career 
                         growth. Enroll for a free demo class today!</p>
                ...
                <div class="col-lg-6 col-md-5">
                    <img class="w-100" src="{{asset('frontend/assets/images/courses/digital-marketing-course-electronic-city.webp')}}" alt="Best-rated Digital Marketing Course in Electronic City, Bangalore - BrandStory Academy">
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 px-2 text-center text-lg-start order-2 order-lg-1">
                    <p><a href="https://www.brandstoryacademy.com" style="color: black; font-size: 18px; text-decoration: underline;"><b>BrandStory Academy</a></b>
                         is a premier digital marketing institute in Electronic City, Bangalore, delivering industry-oriented digital marketing courses with both offline and self-paced
                          learning options. As one of the most successful digital marketing agencies, BrandStory trains students with real-time, industry-relevant skills, offers 
                          hands-on project experience, and prepares them to secure higher packages with a 100% job guarantee.</p>
                    <p>The digital marketing industry is evolving rapidly, and our advanced digital marketing course ensures students stay ahead with the latest AI tools 
                        and modern marketing methodologies. We provide real-world industry insights, make every student job-ready, and place them through our network of 
                        <b>1000+ global partner</b> agencies. As the top digital marketing institute in Electronic City for over 5 years, we ensure no essential skill is missed. 
                        We value every candidate and prioritize their career growth with utmost dedication.</p>
    ...
    <section class="spb-100 why-enroll-coursepage">
        <div class="container">
            ...
            <p class="frame-700 text-center">BrandStory Academy stands as a top digital marketing institute in Bangalore, delivering a practical, industry-driven learning experience. 
                Our seasoned trainers bring years of real-world expertise, ensuring students master every essential aspect of digital marketing with confidence. With a strong 
                network of <b>1000+ placement partners</b>, we help students step into leading global agencies.</p>
            <div class="row whychoose-boxes ">
                <div class="col-12 col-lg-4 mb-4 ">
                    <div class="box y-top">
                        <img src="{{ asset('frontend/assets/images/courses/certificate.svg') }}" />
                        <h4>Certifications</h4>
                        <p>Gain internationally valued certifications from top platforms like Google Ads, HubSpot, and Semrush. These credentials enhance your professional 
                            credibility and give your resume a competitive edge.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box g-top">
                        ...
                        <p>Experience practical learning by working on live SEO, PPC, and social media projects. Track real campaign performance and sharpen your 
                            skills with continuous guidance from industry experts.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box s-top">
                        ...
                        <p>Receive end-to-end placement assistance with personalized resume enhancement, interview practice sessions, and direct 
                            connections to leading companies across multiple sectors.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box r-top">
                        ...
                        <p>Join intensive interview-preparation sessions led by industry experts to sharpen your communication, analytical 
                            thinking, and presentation skills ensuring you step into job opportunities.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box v-top">
                        ...
                        <p>Learn from experienced marketing professionals who share real-world insights and strategies in every class. Choose 
                            between collaborative group sessions or 1-to-1 learning for a tailored learning experience.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box o-top">
                        ...
                        <p>Enhance your communication, leadership, and personal branding abilities to confidently stand out in the digital 
                            world. We provide the right opportunities to help you kickstart a successful career.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="curicullmn-coursepage spb-100">
        <div class="container">
            ...
            <p class="frame-1100 text-center">
                Our digital marketing course covers <b>30 industry-focused modules</b>, offering advanced training with 100% placement support. Backed by 10+ years
                 of expertise, we provide affordable, job-oriented digital marketing coaching in Bangalore.
            </p>
