...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-7 text-md-start text-center">
                    <h1 class="mb-3">Professional <span class="text-violet">Digital Marketing Course </span> in Rajajinagar, Bangalore</h1>
                    <p class="mb-4"><span >Upgrade your career with the most trusted Digital Marketing Course in Rajajinagar. Get trained on 30+ industry-relevant 
                        modules, gain hands-on experience with 50+ marketing tools, and earn 10+ globally valued certifications. With access to 1,000+ hiring partners, 
                        we help you step confidently into high-growth digital marketing roles.</p>
                ...
                <div class="col-lg-6 col-md-5">
                    <img class="w-100" src="{{asset('frontend/assets/images/courses/digital-marketing-course-rajajinagar.webp')}}" alt="Professional Digital Marketing Course in Rajajinagar, Bangalore - BrandStory Academy">
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 px-2 text-center text-lg-start order-2 order-lg-1">
                    <p><a href="https://www.brandstoryacademy.com" style="color: black; font-size: 18px; text-decoration: underline;"><b>BrandStory Academy</a></b>
                        offers the best digital marketing courses in Rajajinagar, dedicated to shaping job-ready digital professionals. We are a industry-leading digital marketing institute 
                        in Bangalore, making learning flexible and accessible for every student. As one of the most trusted digital marketing academies, we train learners using real-time 
                        projects, practical assignments, and essential industry skills that help them secure high-paying roles with a <b>100% job guarantee</b>.</p>
                    <p>With the digital landscape evolving rapidly, our academy delivers advanced digital marketing curriculum that covers modern marketing strategies, hands-on tool training,
                         and the latest industry practices. Students gain real-world exposure, develop strong practical knowledge, and get access to <b>1,000+ hiring partners</b> across India and 
                         abroad. With over <b>5 years of expertise</b> in digital marketing education, BrandStory Academy ensures every learner receives complete guidance, personal attention, 
                         and the skills needed to build a successful career.</p>
    ...
    <section class="spb-100 why-enroll-coursepage">
        <div class="container">
            ...
            <p class="frame-700 text-center">BrandStory Academy is a top digital marketing institute in Rajajinagar, Bangalore, providing a hands-on, industry-oriented learning experience. Our expert 
                faculty guide students through practical strategies, modern techniques, and real-world marketing challenges. With a network of <b>1,000+ placement partners</b>, we ensure our students secure 
                rewarding opportunities.</p>
            <div class="row whychoose-boxes ">
                <div class="col-12 col-lg-4 mb-4 ">
                    <div class="box y-top">
                        <img src="{{ asset('frontend/assets/images/courses/certificate.svg') }}" />
                        <h4>Certifications</h4>
                        <p>Globally recognized certifications from BrandStory Academy and from HubSpot, Google Ads, Semrush, and others. These credentials boost marketing expertise 
                            and help your resume stand out.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box g-top">
                        ...
                        <p>Gain practical experience by managing real SEO, PPC, and social media campaigns while learning to analyze performance metrics with guidance from industry experts.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box s-top">
                        ...
                        <p>Receive complete placement assistance, from crafting impactful resumes and practicing mock interviews to connecting with leading hiring partners across multiple industries.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box r-top">
                        ...
                        <p>Join industry-led interview workshops to enhance your communication, problem-solving, and presentation skills. Our expert guidance ensures you’re fully prepared to excel in job interviews.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box v-top">
                        ...
                        <p>Learn from experienced marketing professionals who share real-world insights in every session. Benefit from both interactive group classes and personalized one-on-one mentoring.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box o-top">
                        ...
                        <p>Build key communication, leadership, and personal branding skills to shine in the digital marketing world. We equip you with the right opportunities to kickstart a successful career.</p>
                    </div>
                </div>
            </div>
