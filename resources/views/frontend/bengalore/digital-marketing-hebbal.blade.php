...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-7 text-md-start text-center">
                    <h1 class="mb-3">Expert-led <span class="text-violet"> Digital Marketing Course</span> in Hebbal, Bangalore</h1>
                    <p class="mb-4"><span >Step into the future of marketing with the advanced Digital Marketing Course in Hebbal offered by BrandStory Academy. 
                        This course empowers learners to master modern marketing skills by blending core digital strategies with the latest tools and 
                        techniques transforming the industry.</p>
                ...
                <div class="col-lg-6 col-md-5">
                    <img class="w-100" src="{{asset('frontend/assets/images/courses/digital-marketing-course-habbel.webp')}}" alt="Expert-led Digital Marketing Course in Hebbal, Bangalore - BrandStory Academy">
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 px-2 text-center text-lg-start order-2 order-lg-1">
                    <p>Founded in 2018, <a href="https://www.brandstoryacademy.com" style="color: black; font-size: 18px; text-decoration: underline;"><b>BrandStory Academy</a></b>
                         has become one of Bangalore’s most trusted institutes for digital marketing education, successfully training 10,000+ students. Built by industry experts from 
                         BrandStory, the academy emphasizes practical, agency-style learning that equips students with real, job-ready skills.
                    </p>
                    <p>With numerous successful batches and a strong network of learners now working across agencies, startups, and global companies, BrandStory Academy continues to bridge 
                        the gap between classroom training and industry expectations. Each student receives hands-on project exposure, personalized mentorship, and training on the <b>latest
                         tools and techniques</b> used in modern digital marketing. Our digital marketing institute in Hebbal offers certification programs, portfolio development support, 
                         and assured placement assistance to help learners confidently achieve their career goals.</p>
    ...
    <section class="spb-100 why-enroll-coursepage">
        <div class="container">
            ...
            <p class="frame-700 text-center">BrandStory Academy stands among Bangalore’s top digital marketing institutes, delivering practical, mentorship-driven 
                training. Our skilled trainers guide students through real-world marketing techniques while our network of <b>1,000+ hiring partners</b> opens doors to 
                global career opportunities.</p>
            <div class="row whychoose-boxes ">
                <div class="col-12 col-lg-4 mb-4 ">
                    <div class="box y-top">
                        <img src="{{ asset('frontend/assets/images/courses/certificate.svg') }}" />
                        <h4>Certifications</h4>
                        <p>Gain globally recognized certifications from platforms like HubSpot, Google Ads, and Semrush. These qualifications enhance 
                            your digital skills and help your resume stand out.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box g-top">
                        ...
                        <p>Work on real SEO, PPC, and social media campaigns to gain practical experience and learn to evaluate 
                            performance metrics with the support of industry experts.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box s-top">
                        ...
                        <p>We provide end-to-end placement support, helping you create strong resumes, prepare through mock interviews, 
                            and connect with leading companies across various sectors.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box r-top">
                        ...
                        <p>Enhance your communication, presentation, and problem-solving skills through our expert-driven interview workshops. 
                            Our guidance ensures you walk into every interview fully prepared. </p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box v-top">
                        ...
                        <p>Gain practical knowledge from industry experts who bring hands-on experience to each session. Choose between 
                            engaging group classes and focused one-on-one learning support.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box o-top">
                        ...
                        <p>Build strong communication, leadership, and personal branding abilities that set you apart in the digital 
                            industry. Our guidance ensures you’re prepared to begin a successful career.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="curicullmn-coursepage spb-100">
        <div class="container">
            ...
            <p class="frame-1100 text-center">
                Our digital marketing course features 30+ comprehensive, <b>industry-focused modules</b> designed to build real-world expertise. As one of Bangalore’s leading 
                digital marketing institutes, we offer advanced training programs combined with <b>100% placement support</b>. With over a decade of experience, we deliver 
                high-quality yet affordable digital marketing coaching to help learners fast-track their careers.
            </p>
