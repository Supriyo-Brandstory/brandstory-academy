...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-7 text-md-start text-center">
                    <h1 class="mb-3">Best <span class="text-violet"> Digital Marketing Course</span> in Jayanagar, Bangalore</h1>
                    <p class="mb-4"><span >Step into the future of marketing with the advanced Digital Marketing Course in Jayanagar offered by 
                        BrandStory Academy. This course helps learners build strong modern marketing skills by blending core digital strategies 
                        with the latest tools and techniques shaping today’s industry.</p>
                ...
                <div class="col-lg-6 col-md-5">
                    <img class="w-100" src="{{asset('frontend/assets/images/courses/digital-marketing-course-jayanagar.webp')}}" alt="Best Digital Marketing Course in Jayanagar, Bangalore - BrandStory Academy">
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 px-2 text-center text-lg-start order-2 order-lg-1">
                    <p><a href="https://www.brandstoryacademy.com" style="color: black; font-size: 18px; text-decoration: underline;"><b>BrandStory Academy</a></b>
                         BrandStory Academy is a leading digital marketing institute in Jayanagar, Bangalore, offering practical, industry-driven training to help 
                         learners build strong digital careers. We provide flexible learning options, including offline classroom sessions and self-paced 
                         programs, all guided by experienced professionals who bring real-world expertise to every class.</p>
                    <p>With the digital landscape evolving rapidly, our Jayanagar centre delivers an advanced curriculum that covers the latest tools, 
                        strategies, and marketing practices. Every student receives exposure to real-time industry insights and is prepared to succeed in 
                        top companies through our network of <b>1,000+ global hiring partners</b>. Backed by over 5 years of excellence in digital marketing education, 
                        BrandStory Academy is committed to providing every learner with personalized attention, strong career guidance, and a path to long-term 
    ...
    <section class="spb-100 why-enroll-coursepage">
        <div class="container">
            ...
            <p class="frame-700 text-center">BrandStory Academy is one of Bangalore’s top digital marketing 
                institutes, delivering expert-led and industry-focused training. Our experienced faculty guide 
                students through practical digital marketing concepts. With over <b>1,000 placement partners</b>, we help 
                our learners secure opportunities at leading agencies worldwide.</p>
            <div class="row whychoose-boxes ">
                <div class="col-12 col-lg-4 mb-4 ">
                    <div class="box y-top">
                        <img src="{{ asset('frontend/assets/images/courses/certificate.svg') }}" />
                        <h4>Certifications</h4>
                        <p>Gain internationally accredited certifications from BrandStory Academy & platforms 
                            like HubSpot, Google Ads, and Semrush. These qualifications enhance your digital 
                ...
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box g-top">
                        ...
                        <p>Gain real-world experience by managing live SEO, PPC, and social media campaigns,
                             and learn to measure and interpret performance metrics with the support of industry 
                             experts.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box s-top">
                        ...
                        <p>GReceive end-to-end placement support, from resume building and mock interviews 
                            to connecting with leading hiring partners across diverse industries.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box r-top">
                        ...
                        <p>We provide expert-led interview workshops that help you sharpen your communication, 
                            presentation, and problem-solving skills. Our guidance ensures you’re fully prepared 
                            to step confidently into your job interviews.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box v-top">
                        ...
                        <p>Learn from experienced marketing professionals who share real-world insights in every session. 
                            Participate in collaborative group classes as well as personalized one-on-one learning sessions</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box o-top">
                        ...
                        <p>Build strong communication, leadership, and personal branding skills to excel in the digital marketing 
                            field. We provide the right opportunities and support to help you launch a successful career.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="curicullmn-coursepage spb-100">
        <div class="container">
            ...
            <p class="frame-1100 text-center">
                Our digital marketing curriculum includes 30 industry-focused modules designed to build strong practical skills. As one of Bangalore’s top digital marketing 
                institutes, we offer an advanced, job-ready course. Backed by over 10 years of expertise, we deliver high-quality and affordable training for aspiring digital 
                marketers.</b>.
            </p>
    ...
    <section class="Certified-coursepage sp-100">
        ...
        <div class="container">
            ...
            <p class="text-center frame mb-5">Earn an industry-recognized digital marketing certificate from <b>BrandStory Academy</b> 
                upon completing your course in Bangalore. This certification validates your skills and helps you stand out 
