...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-7 text-md-start text-center">
                    <h1 class="mb-3">Career-Focused <span class="text-violet"> Digital Marketing Course</span> in OMBR, Bangalore</h1>
                    <p class="mb-4"><span >Step into the future of marketing with BrandStory Academy’s AI-Powered Digital Marketing Course in 
                        OMBR Layout, Bangalore. Designed for today’s fast-changing industry, this course blends core digital marketing 
                        fundamentals with cutting-edge AI tools and techniques that help learners build real, job-ready skills.</p>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 px-2 text-center text-lg-start order-2 order-lg-1">
                    <p>Founded in 2018, <a href="https://www.brandstoryacademy.com" style="color: black; font-size: 18px; text-decoration: underline;"><b>BrandStory Academy</a></b>
                         is a leading digital marketing institute in OMBR Layout, Bangalore, offering practical, industry-focused digital marketing courses through both offline 
                         and self-paced learning formats. Backed by the expertise of BrandStory, one of the most successful digital marketing agencies, we train students using 
                         real-time projects, agency-style workflows, and skill-based learning that helps them secure high-paying roles.
                   </p>
                    <p>With the digital landscape evolving faster than ever, our advanced digital marketing program equips learners with the latest AI tools, updated marketing 
                        strategies, and practical exposure to real-world scenarios. Every student receives hands-on training, personalized guidance, and access to our strong
                         network of <b>1000+ global hiring partners</b>. Recognized as one of the top digital marketing institutes in OMBR Layout for <b>over 5 years</b>, we ensure every
                          learner gains the expertise needed to build a strong, future-ready career.</p>
    ...
    <section class="spb-100 why-enroll-coursepage">
        <div class="container">
            ...
            <p class="frame-700 text-center">BrandStory Academy is a top-rated digital marketing institute in 
                Bangalore, known for expert-led training and real-world learning. Our experienced mentors and 
                <b>1000+ placement partners</b> ensure students are fully prepared for global career opportunities.</p>
            <div class="row whychoose-boxes ">
                <div class="col-12 col-lg-4 mb-4 ">
                    <div class="box y-top">
                        <img src="{{ asset('frontend/assets/images/courses/certificate.svg') }}" />
                        <h4>Certifications</h4>
                        <p>Earn top-tier certifications from leading digital marketing platforms such as HubSpot, Google Ads, 
                            and Semrush, boosting your credibility and giving your profile a competitive edge.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box g-top">
                        ...
                        <p>Get real-world exposure by executing SEO, PPC, and social media campaigns and mastering 
                            performance analysis with step-by-step expert guidance.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box s-top">
                        ...
                        <p>From resume building to mock interviews and exclusive hiring partner access, 
                            we provide complete support to help you land the right job.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box r-top">
                        ...
                        <p>Join expert-driven interview training sessions designed to sharpen your presentation, communication, 
                            and problem-solving skills, ensuring you’re fully prepared for job placements.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box v-top">
                        ...
                        <p>Learn from experienced marketing professionals who share practical industry insights in every class. 
                            Benefit from both group sessions and personalized one-on-one learning.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box o-top">
                        ...
                        <p>Build strong communication, leadership, and personal branding skills that set you apart in the digital field. 
                            We help you access the right opportunities to kick-start your career.</p>
                    </div>
                </div>
            </div>
