...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-7 text-md-start text-center">
                    <h1 class="mb-3">No.1 Digital <span class="text-violet">Marketing Training Course</span> in Malleshwaram, Bangalore</h1>
                    <p class="mb-4"><span>Unlock your digital marketing career at BrandStory Academy. From foundational concepts to advanced strategies, you’ll learn every 
                        aspect of digital marketing while working on real-time projects. Our 6-month digital marketing course in Malleshwaram helps you build practical skills 
                        and earn certifications across digital marketing, SEO, and PPC, to prepare you for a successful 
                        career.</p>
                ...
                <div class="col-lg-6 col-md-5">
                    <img class="w-100" src="{{asset('frontend/assets/images/courses/digital-marketing-course-malleswaram.webp')}}" alt="No.1 Digital Marketing Training Course in Malleshwaram, Bangalore - BrandStory Academy">
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 px-2 text-center text-lg-start order-2 order-lg-1">
                    <p><a href="https://www.brandstoryacademy.com" style="color: black; font-size: 18px; text-decoration: underline;"><b>BrandStory Academy</a></b>
                        BrandStory Academy stands as one of the most trusted digital marketing institutes in Bangalore, offering industry-focused digital marketing 
                        training right in the heart of Malleshwaram. We provide both classroom and self-paced learning options, making it easy for students and working 
                        professionals to choose what suits them best.</p>
                    <p>Backed by BrandStory’s strong presence as a leading digital marketing agency, our students learn directly from experts who work on <b>real client projects</b> 
                        every day. With practical training, hands-on assignments, and live project exposure, we equip learners with the exact skills top companies look for. 
                        Our programs are designed to help students secure high-paying roles, supported by complete placement assistance. We provide real-world insights, 
                        prepare students for job-ready roles, and connect them with over <b>1,000 partner agencies</b> across India.</p>
    ...
    <section class="spb-100 why-enroll-coursepage">
        <div class="container">
            ...
            <p class="frame-700 text-center">BrandStory Academy is a top-rated digital marketing institute in Bangalore, known for delivering practical, industry-driven training.
                 With a strong network of <b>1000+ hiring partners</b>, we help our learners secure 
                opportunities across leading agencies.</p>
            <div class="row whychoose-boxes ">
                <div class="col-12 col-lg-4 mb-4 ">
                    <div class="box y-top">
                        <img src="{{ asset('frontend/assets/images/courses/certificate.svg') }}" />
                        <h4>Certifications</h4>
                        <p>Gain globally recognized certifications from platforms like HubSpot, Google Ads, Semrush, and more. These credentials enhance your digital marketing 
                            expertise and give your resume a competitive edge.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box g-top">
                        ...
                        <p>Receive complete placement assistance, from personalized resume building and mock interview sessions to exclusive access to leading hiring partners 
                ...
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box r-top">
                        ...
                        <p>Join expert-led interview training sessions designed to sharpen your communication, problem-solving, and presentation skills. Our dedicated 
                            mentors ensure you’re fully prepared for job interviews.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box v-top">
                        ...
                        <p>Gain knowledge from experienced marketing experts who share practical industry insights in every class. Benefit from both collaborative 
                            group sessions and one-on-one learning support.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box o-top">
                        ...
                        <p>Build strong communication, leadership, and personal branding skills that help you stand out in the digital marketing field. We ensure 
                            you’re equipped with the right opportunities to launch a successful career.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="curicullmn-coursepage spb-100">
        <div class="container">
            ...
            <p class="frame-1100 text-center">
                Our digital marketing program includes <b>30 industry-relevant modules</b> designed to match current market demands. As one of 
                Bangalore’s top digital marketing institutes, we offer an advanced curriculum paired with complete placement assistance.
            </p>
    ...
    <section class="Benefit-coursepage">
        <div class="container">
            ...
            <p class="text-center frame-800">Our digital marketing course in Malleswaram is designed for people who want to
