        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-5">
                    <img class="w-100" src="{{asset('frontend/assets/images/courses/digital-marketing-course-indiranagar.webp')}}" alt="Digital Marketing training traing in Indiranagar - BrandStory Academy">
                </div>
            </div>
