...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-7 text-md-start text-center">
                    <h1 class="mb-3">Job-ready Digital<span class="text-violet"> Marketing Course</span> in HSR Layout, Bangalore</h1>
                    <p class="mb-4"><span>Kickstart your digital marketing journey at BrandStory Academy. Learn everything from basic concepts to advanced
                         marketing techniques through a blend of interactive sessions and real-world project experience. Our 6-month digital marketing course 
                         in HSR Layout is designed to build your practical skills, boost your confidence, and help you earn valuable certifications in digital 
                         marketing, SEO, and PPC.</p>
                ...
                <div class="col-lg-6 col-md-5">
                    <img class="w-100" src="{{asset('frontend/assets/images/courses/digital-marketing-course-hsr-layout.webp')}}" alt="Job-ready Digital Marketing Course in HSR Layout, Bangalore - BrandStory Academy">
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 px-2 text-center text-lg-start order-2 order-lg-1">
                    <p><a href="https://www.brandstoryacademy.com" style="color: black; font-size: 18px; text-decoration: underline;"><b>BrandStory Academy</a></b>
                        is a premier digital marketing institute in HSR Layout, known for offering industry-focused digital marketing courses designed to build real 
                        expertise. We provide both offline classes in HSR Layout and flexible self-paced learning options, ensuring every student can learn in a 
                        way that suits their schedule.</p>
                    <p>The digital marketing landscape is evolving rapidly, and our advanced digital marketing course in HSR Layout ensures students stay ahead. We 
                        train learners using the <b>latest AI tools</b>, updated strategies, and modern marketing techniques. Every student gains real-world industry 
                        exposure and becomes job-ready, with placement opportunities across our network of 1000+ global partner agencies. Through hands-on projects, 
                        live campaigns, and expert mentorship, we prepare them to secure higher packages and benefit from our <b>100% job guarantee</b>.</p>
    ...
    <section class="spb-100 why-enroll-coursepage">
        <div class="container">
            ...
            <p class="frame-700 text-center">BrandStory Academy stands among the top digital marketing institutes in Bangalore, 
                delivering an expert-led and industry-driven learning experience. With a strong network of <b>1000+ placement partners</b>, 
                we successfully place our students in leading global agencies and fast-growing companies.</p>
            <div class="row whychoose-boxes ">
                <div class="col-12 col-lg-4 mb-4 ">
                    <div class="box y-top">
                        <img src="{{ asset('frontend/assets/images/courses/certificate.svg') }}" />
                        <h4>Certifications</h4>
                        <p>Earn internationally recognized certifications from HubSpot, Google Ads, Semrush, and more, boosting your digital 
                            marketing expertise and making your resume stand out with greater credibility.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box g-top">
                        ...
                        <p>Gain practical experience by working on live SEO, PPC, and social media campaigns while tracking and analyzing
                             real performance metrics with expert guidance at every step.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box s-top">
                        ...
                        <p>Get end-to-end placement support with professional resume building, mock interview preparation, and 
                            direct access to top hiring partners across multiple industries.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box r-top">
                        ...
                        <p>Take part in expert-led interview workshops designed to sharpen your presentation, problem-solving,
                             and communication skills. Our guidance ensures you are fully prepared and job-ready.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box v-top">
                        ...
                        <p>Learn from experienced marketing professionals who bring real-world insights to every session. Benefit 
                            from both collaborative group learning and personalized 1-to-1 guidance.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box o-top">
                        ...
                        <p>Build strong communication, leadership, and personal branding skills that help you stand out in the digital 
                            industry. We ensure you’re equipped with the right opportunities to successfully launch your career.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="curicullmn-coursepage spb-100">
        <div class="container">
            ...
            <p class="frame-1100 text-center">
                Our digital marketing course includes <b>30 industry-focused modules</b> designed to build strong practical expertise. As one of the best digital marketing
                 institutes in Bangalore, we offer an advanced curriculum along with <b>100% placement support</b>. 
            </p>
