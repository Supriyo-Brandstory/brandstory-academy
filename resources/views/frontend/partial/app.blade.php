...
<head>
    ...
    <link rel="shortcut icon" href="https://blr1.digitaloceanspaces.com/brandstory/2018/04/favicon.png"
        type="image/x-icon">
    {!! $seo->script ?? '<title>#1 Digital Marketing Institute in Bangalore: BrandStory Academy</title>' !!}
    <link rel="preload" href="{{ asset('frontend/assets/fonts/HankenGrotesk-Regular.woff2') }}" as="font"
    ...
    <meta name="google-site-verification" content="y_Tb-RzvFLj9Pv4A4sc2MGZEC24q03sxiEdjIGbL04k" />
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-5CF6TMZ5');
    </script>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5CF6TMZ5" height="0" width="0"
            ...
            <div class="homeform-main popfrm form-main">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-check mb-3 w-100">
                                    ...
                                    <label class="form-check-label" for="program1_popup">Digital Marketing
                                        Mastery</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-check mb-3 w-100">
                                    ...
                                    <label class="form-check-label" for="program2_popup">Advanced Digital Marketing
                                        Boot Camp</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-check w-100">
                                    <input class="form-check-input" type="radio" name="program"
                                        id="program3_popup" value="360 Degree Digital Marketing" required>
                                    <label class="form-check-label" for="program3_popup">360 Degree Digital
                                        Marketing</label>
                                </div>
                            </div>
                        </div>
                ...
                @if (session('success'))
                    <div class="alert alert-success alert-dismissible fade show rounded-pill mt-4" role="alert">
                        {{ session('success') }}
                        <button type="button" class="btn-close" style="transform: scale(0.85);"
        ...
        document.addEventListener("DOMContentLoaded", function() {
            function initializeRadioButtons(container) {
                ...
                radioButtons.forEach((radio) => {
                    radio.addEventListener("change", function() {
                        container.querySelectorAll(".form-check").forEach((div) => div.classList
                            .remove("selected"));
            ...
            if (popupEl) {
                popupEl.addEventListener("click", function(event) {
                    if (event.target.classList.contains("popup-overlay") || event.target.classList.contains(
                            "close-btn")) {
                    ...
                    grecaptcha.execute('{{ env('RECAPTCHA_SITE_KEY') }}', {
                        ...
                        fetch(form.action, {
                            ...
                            .then(data => {
                                ...
                                const internshipPopup = document.querySelector(
                                    "#internshipPopup");
                                if (internshipPopup) {
                                ...
                                if (data.status === 'success') {
                                    ...
                                    if (data.errors) {
                                        for (const key in data.errors) {
                                            errorText += data.errors[key].join('<br>') +
                                                '<br>';
                                        }
                                    } else {
