    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-7 text-md-start text-center align-self-center">
                ...
                <p class="mb-2">BrandStory Academy proudly offers the <span class="fw-600 text-blue">Digital Marketing Mastery Program</span> — your gateway to mastering digital marketing strategies, AI tools, and real-world applications.</p>
...
<section class="pb-5 mb-t-space" >
    <div class="container lesson-box-shadow">
        ...
        <p>Looking for a short term digital marketing course in Bangalore that delivers maximum impact? BrandStory Academy’s Digital Marketing Mastery Program is designed to equip you with the most in-demand skills in just 6 months.</p>
        <p>Powered by AI and advanced technologies, this course gives you real agency exposure, live project experience, and hands-on learning. Our program goes beyond theories — you will apply trending strategies, analyze campaigns, and optimize results like a pro.</p>
        <p>This affordable digital marketing course in Bangalore offers the perfect blend of classroom learning and real-world internship experience, helping you launch your career faster and smarter.</p>
    </div>
...
<section class="py-5 mb-tb-space">
    <div class="container">
        ...
        <div class="row g-0">
            <div class="col-lg-6 ">
                <img class="w-100 h-100 mb-lg-0 mb-3 d-lg-block d-none" src="{{asset('frontend/assets/images/digital-marketing-with-ai-j/image020.jpg')}}">
                <img class="w-100 mb-3 d-lg-none d-block" src="{{asset('frontend/assets/images/digital-marketing-with-ai-j/image020.jpg')}}">
            </div>
            <div class="col-lg-6 lesson-box-shadow">
                ...
                <p class="fs-16">Our AI-powered Digital Marketing Mastery course is curated for aspiring marketers, entrepreneurs, business owners, and career-switchers who want to stand out in today’s digital-first world.</p>
                <p class="fs-16">With a strong focus on practical implementation, you'll dive deep into SEO, SEM, social media marketing, performance marketing, email campaigns, branding, and automation. You'll also learn how to leverage cutting-edge AI tools to streamline marketing activities and drive superior results.</p>
                <p class="fs-16">By the end of the course, you won't just know digital marketing — you'll live it, with agency-style training and six months of practical internship experience at your fingertips.</p>
                <p class="fs-16 para-clr mb-3"><span class="text-blue">Duration:</span> 2.5 Months + 6 Months Internship</p>
        ...
        <div class="row">
            <div class="col-lg-5">
               ...
               <h2 class="mb-3 text-md-start text-center">Tools You <span class="text-violet">Will Learn</span></h2>
                <p class="mb-4 text-md-start text-center">Stay ahead of the curve with industry-leading marketing and AI tools, including:
                </p>
                <div class="row">
                    <div class="col-1"><img class="me-2 mt-1" src="{{asset('frontend/assets/images/digital-marketing-with-ai-j/image005.svg')}}"></div>
                    <div class="col-11"><p><b>SEO & Analytics</b>: Surfer SEO, SEMrush, Ahrefs, Google Analytics 4, Search Console</p></div>
                    <div class="col-1"><img class="me-2 mt-1" src="{{asset('frontend/assets/images/digital-marketing-with-ai-j/image006.svg')}}"></div>
                    <div class="col-11"><p><b>AI Tools</b>: ChatGPT, Jasper, Copy.ai, Canva</p></div>
                    <div class="col-1"><img class="me-2 mt-1" src="{{asset('frontend/assets/images/digital-marketing-with-ai-j/image007.svg')}}"></div>
                    <div class="col-11"><p><b>Ads & Automation</b>: Google Ads, Meta Ads Manager, LinkedIn Ads, Zapier, HubSpot, CRM Tools</p></div>
                    <div class="col-1"><img class="me-2 mt-1" src="{{asset('frontend/assets/images/digital-marketing-with-ai-j/image008.svg')}}"></div>
                    <div class="col-11"><p><b>Performance Tracking</b>: Hotjar, Tag Manager, Crazy Egg</p></div>
                </div>
    ...
    <div class="container position-relative">
        <div class="row">
            <div class="col-lg-12 col-md-8">
                <h3 class="mb-md-4 mb-3 fw-600 text-md-start text-center">Secure Your Spot in The <span class="text-green1"> Digital Marketing Mastery <br>Program </span></h3>
                <p class="fs-16 fw-500 mb-4 text-md-start text-center">Do not miss the opportunity to join Bangalore's most practical and budget-friendly digital<br> marketing course. Learn from industry experts, get work experience,<br> and master AI-powered marketing strategies — all at a discounted fee of ₹35,000!</p>
                <p class="fs-16 fw-500 mb-4 text-md-start text-center">Fill out the form below and start your journey towards digital success today.</p>
    ...
    <div class="container ">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p>Located in the heart of Bengaluru, we are proud to be the city’s most trusted digital marketing learning hub.</p>
