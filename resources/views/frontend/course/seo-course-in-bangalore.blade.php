...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 order-2 order-lg-1 col-md-7 text-md-start text-center align-self-center mt-3">
                    ...
                    <p class="mb-2">Enroll in the best SEO course and training institute in Bangalore to gain real-world expertise in Search 
                        Engine Optimization. Our SEO course covers on-page, off-page, and technical SEO to help you get 
                        industry-grade knowledge. We provide 1,000+ Placement Partners,  99% Placement Assurance, and 15+ Industry Certifications.
                    </p>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 px-2 text-center text-lg-start order-2 order-lg-1">
                    <p><a href="https://www.brandstoryacademy.com" style="color: black; font-size: 18px; text-decoration: underline;"><b>BrandStory Academy</a></b>
                        is among the best digital marketing & <b>SEO training institutes in Bangalore</b>. We provide industry-oriented SEO courses in Bangalore, both 
                        offline and self-paced learning options. We have 5+ years of expertise in training students and providing them with placement opportunities 
                        in <b>1000+ global brands</b>.</p>
                    <p>Our SEO course in Bangalore covers everything from on-page SEO, off-page SEO, <b>technical SEO implementation</b>, and link-building strategies. With 
                        BrandStory Academy, you can avail <b>online and self-paced learning options</b> at your convenience. Through our Google Search Engine Optimization course, 
                        students can gain real-world expertise in SEO as well as digital marketing. We are the top institute <b>offering SEO courses for 5+ years</b>, ensuring 
    ...
    <section class="spb-100 why-enroll-coursepage">
        <div class="container">
            ...
            <p class="frame-700 text-center">BrandStory Academy is the best <b>SEO training institute</b> to help you master all essentials with real project experience. Our SEO course in Bangalore 
                is designed by the most seasoned industry professionals, ensuring you gain <b>job-ready skills</b> and hands-on learning experience. </p>
            <div class="row whychoose-boxes ">
                <div class="col-12 col-lg-4 mb-4 ">
                    <div class="box y-top">
                        <img src="{{ asset('frontend/assets/images/courses/certificate.svg') }}" />
                        <h4>Hands-on Training</h4>
                        <p>Master useful SEO tools like Semrush, Ahrefs, Google Search Console, Google Analytics, Tag Manager, etc. Our expert trainers will guide
                ...
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box g-top">
                        ...
                        <p>Get mentorship from the real industry professionals who guide you through setting up competitor audit, keyword research, and strategy for live SEO projects.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box s-top">
                        ...
                        <p>Participate in various career grooming programs and sessions regarding SEO interview questions, presenting a portfolio, and communication skill development.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box r-top">
                        ...
                        <p>PConnect with expert marketing professionals and various recruiters through personalized workshops and webinars to help you expand your career network. </p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box v-top">
                        ...
                        <p>BrandStory Academy offers 100% placement assurance for students pursuing the SEO course in Bangalore. Secure placement in top companies across India with us.</p>
                    </div>
                </div>
                <div class="col-12 col-lg-4 mb-4">
                    <div class="box o-top">
                        ...
                        <p>Earn global recognition and certification from HubSpot, Ahrefs, Semrush, etc. These credentials strengthen your digital expertise and make your resume stand out.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="curicullmn-coursepage spb-100">
        <div class="container">
            ...
            <p class="frame-1100 text-center">
                Our full-suite SEO course in Bangalore includes <b>13+ expertly designed modules</b> to make you an industry-ready professional. <b>“Full-suite”</b> means we start from the fundamentals to the advanced strategies of search engine optimization.
            </p>
    ...
    <section class="Benefit-coursepage">
        <div class="container">
            ...
            <p class="text-center frame-800">We provide the best SEO course and training in Bangalore for students, business owners, 
                and working professionals. With BrandStory Academy SEO course you can gain the <a href="https://brandstoryacademy.com/blogs/key-digital-marketing-skills-youll-master-in-a-digital-marketing-course" style="color: black; font-size: 18px; text-decoration: underline;"><strong>hands-on skills</strong></a> of local SEO, e-commerce SEO, 
                AI SEO, and advanced SEO strategies like nowhere before. We help you become a <b>beginner to pro</b> under a nurturing ecosystem led 
    ...
    <section class="Costs-coursepage">
        <div class="container">
            ...
            <p class="text-center frame-800 mb-5">Our modern-day SEO training institute in Bangalore equips you with industry-grade learning at affordable costs. 
                We provide you with the latest SEO tools, advanced strategies, case studies, real projects, conceptual learning, globally recognized certification, 
                and <a href="https://brandstoryacademy.com/placement" style="color: white; font-size: 18px; text-decoration: underline;"><strong>100% placement support</strong></a> 
    ...
    <section class="Certified-coursepage sp-100">
        ...
        <div class="container">
            ...
            <p class="text-center frame mb-5">After completing our SEO course in Bangalore at BrandStory Academy, you’ll get a 
                certificate that is recognized by all agencies across India & abroad. We provide <b>1 training certificate</b> along 
    ...
    <section class="Tools-coursepage">
        <div class="container">
            ...
            <div class="grid-four">
                ...
                <div class="img-box">
                    <img src="{{ asset('frontend/assets/images/courses/semrush.png')}}" alt="SEO Certification on Semrush" />
                </div>
                <div class="img-box">
                    <img src="{{ asset('frontend/assets/images/courses/hubspot.png')}}" alt="SEO Certification on Hubspot" />
                </div>
                <div class="img-box">
                    <img src="{{ asset('frontend/assets/images/courses/ahrefs.png')}}" alt="SEO Certification on Ahrefs" />
                </div>
    ...
    <section class="testimonial-section" id="testimony">
        ...
        <div class="testimonial-row left-to-right">
            ...
            <div class="testimonial">
                <img src="{{asset('frontend/assets/images/quoteicon.png')}}" class="img-fluid mb-4" width="40">
                <p>Recently had the pleasure of experiencing BrandStory Academy, and I must say, it exceeded my
                    expectations. From the moment I enrolled in SEO Course, the academy’s dedication to nurturing professional growth and
                    providing high-quality education was evident.</p>
                <div class="d-flex align-items-center g-4">
                    <div class="profile"></div>
                    Jerophin Jeevitha
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p class="mb-0 fs-16">In today’s digital-first world, visibility is everything. SEO helps businesses 
                                            appear on top of search results, attract the right audience, and build trust with potential customers. 
                                            Unlike paid ads, SEO drives long-term growth through organic reach, making it one of the most cost-effective 
                                            and sustainable marketing strategies. Businesses that invest in SEO gain a strong competitive advantage in their 
                                            industry.
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div class="accordion-body">
                                        <ul class="mb-0">
                                            <p class="mb-0 fs-16">No, coding is not mandatory to master SEO. While a basic 
                                                understanding of website structure and HTML tags can help, SEO is more about strategy, 
                                                creativity, content, and data interpretation. Our instructors guide you step-by-step, 
                                                ensuring you understand both the technical and non-technical aspects with ease.
                                            </p>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p class="mb-0 fs-16">Yes, BrandStory Academy offers both online and classroom learning options. 
                                            The online sessions are live and interactive, allowing you to engage directly with mentors, 
                                            ask questions in real-time, and participate in practical exercises- just like in a classroom setup. 
                                            You can choose the format that best suits your schedule and learning preferences.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapsefour" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p class="mb-0 fs-16">At BrandStory Academy, we focus on job-oriented and practical learning. 
                                            Our trainers are industry professionals who share real-world insights, case studies, and proven 
                                            strategies. You’ll gain hands-on experience through live projects, performance tracking, and exposure 
                                            to premium tools- ensuring you graduate not just with knowledge, but with the skills employers truly 
                                            value.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapsefive" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p class="mb-0 fs-16">The course includes On-page SEO, Off-page SEO, Technical SEO, Keyword Research, 
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseseven" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p class="mb-0 fs-16">Yes, BrandStory Academy provides flexible batch timings and online 
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample1">
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapsenine" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <ul class="mb-0">
                                            <p class="mb-0 fs-16">After successfully completing the program, you will receive an industry-recognized 
                                                BrandStory Academy SEO Certification. In addition, we guide you to earn free and valuable certifications 
                                                from Google, HubSpot, and Semrush, which further strengthen your professional portfolio and credibility 
                                                in the job market.
                                            </p>
                                        </ul>
                                    </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseten" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <ul class="mb-0">
                                            <p class="mb-0 fs-16">Absolutely, we provide dedicated <b>100% placement assistance</b> to help 
                                                students transition smoothly into the industry. From resume-building and mock interviews 
                                                to connecting you with hiring partners and agencies, our team ensures you’re ready to take 
                                                on real-world roles in digital marketing. We have <b>1000+ dedicated placement partners</b> to help 
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseten" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <ul class="mb-0">
                                            <p class="mb-0 fs-16">After completing the course, you can explore diverse roles such as 
                                                SEO Executive, Digital Marketing Analyst, Content Strategist, SEO Copywriter, or SEO Manager. 
                                                With experience, you can also progress into specialized roles like Technical SEO Specialist, 
                                                SEO Consultant, or Digital Marketing Lead. The <b>demand for SEO professionals is growing</b> rapidly 
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseten" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <ul class="mb-0">
                                            <p class="mb-0 fs-16">Salaries in SEO depend on experience, skills, and performance. Beginners can 
                                                expect a starting package of <b>₹2.5 LPA to ₹6.5 LPA</b>, while experienced professionals can earn 
                                                anywhere from ₹8 LPA to ₹15 LPA or even higher in managerial roles. With experience and continuous 
                                                learning, SEO professionals can build a highly rewarding career in digital marketing.</p>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseeleven" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p class="mb-0 fs-16">Definitely, as businesses increasingly shift online, SEO remains one of the most sought-after 
                                            digital marketing skills. Companies across industries are actively looking for SEO experts who can help them 
                                            grow visibility, generate leads, and outperform competitors. It’s a career that combines creativity, strategy, 
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample2">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapsefourteen" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p class="mb-0 fs-16">The SEO Course in Bangalore at BrandStory Academy is <b>priced at ₹30,000</b>, offering excellent value through 
